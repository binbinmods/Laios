...
namespace Laios
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        public static string characterName = "Laios";
        public static string heroName = characterName;

        public static string subclassName = "Enforcer"; // needs caps
        ...
        private void Awake()
        {
            ...
            RegisterMod(
                ...
                _author: "binbin",
                _description: "Laios, the Enforcer.",
                _version: PluginInfo.PLUGIN_VERSION,
                _date: ModDate,
                _link: @"https://github.com/binbinmods/Laios",
                _contentFolder: "Laios",
